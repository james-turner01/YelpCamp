...
map.on('load', () => {
    ...
    // zooms you in when you click on a cluster
    map.on('click', 'clusters', (e) => {
        ...
        map.getSource('campgrounds').getClusterExpansionZoom(
            ...
            (err, zoom) => {
                if (err) return;
                // change the center of whre we ease to
                map.easeTo({
    ...
    map.on('click', 'unclustered-point', (e) => {
        // getting popupMarkup from e.features[0].properties.popupMarkup
    ...
    //changes cursor when it is over a cluster
